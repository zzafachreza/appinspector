...
export default function Add6({ navigation, route }) {
    ...
    const sendServer = () => {
        ...
        if (!kirim.foto) {
            ...
            axios.post(apiURL + 'cek_add6', kirim).then(res => {
                setLoading(false);
    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{
                ...
                <MyPilih judul='TIDAK DILENGKAPI DENGAN CHECKLIST PEMELIHARAAN' no={1} />
                <MyPilih judul='TIDAK DILENGKAPI DENGAN PENANDA' no={2} />
                <MyPilih judul='UKURAN PENGHANTAR TIDAK SESUAI' no={3} />
                <MyPilih judul='TIDAK DILENGKAPI DENGAN GROUNDING' no={4} />
                <MyPilih judul='UKURAN STICK ROD TIDAK SESUAI' no={5} />
                <MyPilih judul='TIDAK DILENGKAPI BAK KONTROL' no={6} />
                <MyPilih judul='TUTUP BAK KONTROL RUSAK' no={7} />
                <MyPilih judul='TANDA PENGENAL KABEL TIDAK SESUAI' no={8} />

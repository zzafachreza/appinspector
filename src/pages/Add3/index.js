...
export default function Add3({ navigation, route }) {
    ...
    const sendServer = () => {
        ...
        if (!kirim.foto) {
            ...
            axios.post(apiURL + 'cek_add3', kirim).then(res => {
                setLoading(false);
    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{
                ...
                <MyPilih judul='TIDAK DILENGKAPI DENGAN STANDAR OPERASIONAL PROSEDUR' no={6} />
                <MyPilih judul='TIDAK DILENGKAPI DENGAN GROUNDING' no={7} />

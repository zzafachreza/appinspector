...
export default function Add4({ navigation, route }) {
    ...
    const sendServer = () => {
        ...
        if (!kirim.foto) {
            ...
            axios.post(apiURL + 'cek_add4', kirim).then(res => {
                setLoading(false);
    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{
                ...
                <MyPilih judul='INSTALASI TERHALANG VEGETASI' no={1} />
                <MyPilih judul='TERDAPAT KABEL YANG TERBUKA / TEREKSPOSE' no={2} />
                <MyPilih judul='UKURAN KABEL TIDAK SESUAI' no={3} />

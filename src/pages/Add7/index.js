...
export default function Add7({ navigation, route }) {
    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{
                ...
                <MyPilih judul="RUSAK FISIK" no={5} />
                <MyPilih judul="TIDAK DILENGKAPI DENGAN GROUNDING" no={6} />
                <MyPilih judul="RUANG BEBAS PANEL TIDAK MENCUKUPI" no={7} />
                <MyPilih judul="LAMPU INDIKATOR RUSAK" no={8} />
                <MyPilih judul="INDIKATOR UKUR RUSAK" no={9} />
